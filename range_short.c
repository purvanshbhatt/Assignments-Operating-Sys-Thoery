...
int main() {
    ...
    int numberOfBytesInShort = sizeof(short);
    int numberOfBitsInShort = 8 * numberOfBytesInShort;

    min_short = -(1 << (numberOfBitsInShort - 1));
    max_short = (1 << (numberOfBitsInShort - 1)) - 1;
    printf("%hd ", min_short);
    printf("%hd\n", max_short);
    return 0;
}
